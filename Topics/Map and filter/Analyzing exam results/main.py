...
overall_scores = list(map(lambda math, pyhsics, english: math + pyhsics + english, scores_maths, scores_physics,
                          scores_english))

admitted_students = list(filter(lambda points: points >= 270, overall_scores))
